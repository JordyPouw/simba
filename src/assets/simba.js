...
// doubleTapToGo.js: by Osvaldas Valutis. osvaldas.info/drop-down-navigation-responsive-and-touch-friendly.
...
$(document).ready(function(){
  $('.filter__mode--grid').click(function(){
    // $('#filter__value__mode').val('{{ collection.modes.grid.id }}');
    $('#filter__value__mode').val('grid');
    $('#filter__values').submit();
  });
  
  $('.filter__mode--list').click(function(){
    // $('#filter__value__mode').val('{{ collection.modes.list.id }}');
